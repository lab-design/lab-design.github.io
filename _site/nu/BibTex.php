<?php
  ...
  /***********************************************************************/
  /* MODIFIED BY ROBERT DYER TO WORK ON PHP < 4.3.0 WITHOUT PEAR SUPPORT */
  /***********************************************************************/
...
class Structures_BibTex
{
    ...
    function Structures_BibTex($options = array())
    {
        ...
        $this->authorstring = 'FIRST VON LAST JR';
    }
    ...
    function loadFile($filename)
    {
        if (file_exists($filename)) {
            if (($this->content = $this->file_get_contents($filename)) === false) {
