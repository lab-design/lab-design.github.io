...
The project, [Collaborative Research: SHF: Small: Fault Localization for Deep Learning](https://www.nsf.gov/awardsearch/showAward?AWD_ID=2419882), is supported by NSF's Directorate for Computer and Information Science and Engineering. It is a collaborative award across [Tulane](https://www.nsf.gov/awardsearch/showAward?AWD_ID=2419882) and [Oakland](https://www.nsf.gov/awardsearch/showAward?AWD_ID=2419883), totaling roughly $600,000 over three years.
...
This work builds directly on Mohammad's doctoral research, including [DeepLocalize](/news/2021/05/25/deeplocalize-fault-localization/), our first approach for bug localization in deep neural networks. For the wider story, see our overview of [debugging deep learning](/news/2025/10/15/why-deep-learning-needs-debugging-tools/). I am grateful to NSF for the support, and excited to get started.
